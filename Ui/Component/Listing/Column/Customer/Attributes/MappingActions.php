...
namespace BitTools\SkyHub\Ui\Component\Listing\Column\Customer\Attributes;
...
class MappingActions extends Column
{
    ...
    /** @var string */
    const URL_PATH_EDIT        = 'bittools_skyhub/customer_attributes_mapping/edit';
    const URL_PATH_CREATE      = 'bittools_skyhub/customer_attributes_mapping/autoCreate';
    const URL_PATH_UNASSOCIATE = 'bittools_skyhub/customer_attributes_mapping/unassociate';
